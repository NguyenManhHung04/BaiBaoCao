...
use App\Http\Controllers\frontend\Hungpost;
...
Route::get('tat-ca-san-pham', [SanPhamController::class, 'index'])->name('site.product');
...
// bài viết
Route::get('tat-ca-bai-viet', [Hungpost::class, 'index'])->name('site.Hungpost');
Route::get('postdetail/{slug}', [Hungpost::class, 'post_detail'])->name('site.postdetail_slug');
...
Route::get("dang-xuat", [AuthController::class, "logout"])->name('website.dologout');
...
Route::get("lien-he", [AuthController::class, "getcontact"])->name('website.getcontact');
Route::post("lien-he", [AuthController::class, "docontact"])->name('website.docontact');
